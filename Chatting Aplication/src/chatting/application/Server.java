...
public class Server implements ActionListener{
    ...
    Server(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/s.png"));
       ...
       ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/video.png"));
       ...
       JLabel l3 = new JLabel("Sojib Ali");
